...
Public Class crpPlaniGrid
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PlaniSoftwareControlLibrary.crpPlaniGrid.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpPlaniGrid
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpPlaniGrid = New crpPlaniGrid()
        rpt.Site = Me.Site
        Return rpt
    End Function
